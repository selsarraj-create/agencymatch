...
def process_digitals(image_url: str):
    ...
    cleanup_prompt = (
        "Professional studio headshot of the EXACT same person from the input image: "
        "identical face, identity, age, skin tone, and hair. "
        "Do NOT change, smooth, reshape, or alter the face in ANY way. "
        "Copy the face EXACTLY as it appears in the input.\n"
        "TASK:\n"
