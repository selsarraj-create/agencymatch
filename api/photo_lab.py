...
def process_digitals(image_url: str):
    ...
    cleanup_prompt = (
        ...
        "the output MUST also be a close-up where the head fills the same amount of the frame. "
        "Do NOT pull back, zoom out, or show more of the body than the input does. "
        "The face size relative to the frame must be IDENTICAL to the input.\n"
        "- NO HDR OR SHARPENING: Match the exact SOFTNESS, resolution, and blur of the original photo. "
        "Do NOT add micro-contrast. Do NOT enhance pores, wrinkles, or skin texture. "
        "The output should look like a soft, unedited phone camera selfie.\n"
        "- Use soft, flat lighting. Do not add dramatic shadows or highlights.\n"
