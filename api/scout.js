...
function mapToActions(selectorMap, userData) {
    ...
    const fieldMapping = {
        ...
        bust: () => userData.bust || userData.bust_cm || "",
        waist: () => userData.waist || userData.waist_cm || "",
        hips: () => userData.hips || userData.hips_cm || "",
        shoeSize: () => userData.shoe_size || userData.shoe_size_uk || "",
        eyeColor: () => userData.eye_color || "",
        hairColor: () => userData.hair_color || "",
        instagramHandle: () => userData.instagram || userData.instagram_handle || "",
        aboutMe: () => userData.about || userData.bio || "",
        howDidYouHear: () => "Online Search",
        city: () => userData.city || "",
        nationality: () => userData.nationality || "",
        ethnicity: () => userData.ethnicity || "",
        tiktokHandle: () => userData.tiktok || userData.tiktok_handle || "",
        dressSize: () => userData.dress_size || "",
    };
